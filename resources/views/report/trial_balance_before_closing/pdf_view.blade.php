        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($date_query as $entry)
                    @if (Str::startsWith($entry->gls_account_code, '1'))
                        ...
                        <tr>
                            ...
                            <td class="text-end color-green {{ $entry->after_total < 0 ? 'error-message' : '' }}">
                            ...
                            <td class="text-end color-blue {{ $entry->total < 0 ? 'error-message' : '' }}">
                ...
                <tr>
                    ...
                    <td class="text-end color-yellow text-bold {{ $before_total_1 < 0 ? 'error-message' : '' }}">
                        {{ $before_total_1 != 0 ? number_format($before_total_1, 2) : '' }}</td>
                    <td class="text-end color-yellow">
                    </td>

                    <td class="text-end color-green text-bold {{ $after_total_1 < 0 ? 'error-message' : '' }}">
                        {{ $after_total_1 != 0 ? number_format($after_total_1, 2) : '' }}</td>
                    <td class="text-end color-green">
                    </td>

                    <td class="text-end color-blue text-bold {{ $total_1 < 0 ? 'error-message' : '' }}">
                ...
                <tr>
                    ...
                    <td class="text-end color-yellow text-bold {{ $before_total_2 < 0 ? 'error-message' : '' }}">
                        {{ $before_total_2 != 0 ? number_format($before_total_2, 2) : '' }}</td>
                    <td class="text-end color-green">
                    </td>
                    <td class="text-end color-green text-bold {{ $after_total_2 < 0 ? 'error-message' : '' }}">
                        {{ $after_total_2 != 0 ? number_format($after_total_2, 2) : '' }}</td>

                    <td class="text-end color-blue"></td>
                    <td class="text-end color-blue text-bold {{ $total_2 < 0 ? 'error-message' : '' }}">
                ...
                <tr>
                    ...
                    <td class="text-end color-yellow text-bold {{ $before_total_4 < 0 ? 'error-message' : '' }}">
                        {{ $before_total_4 != 0 ? number_format($before_total_4, 2) : '' }}</td>
                    <td class="text-end color-green">
                    </td>
                    <td class="text-end color-green text-bold {{ $after_total_4 < 0 ? 'error-message' : '' }}">
                        {{ $after_total_4 != 0 ? number_format($after_total_4, 2) : '' }}</td>
                    <td class="text-end color-blue"></td>
                    <td class="text-end color-blue text-bold {{ $total_4 < 0 ? 'error-message' : '' }}">
                ...
                <tr>
                    ...
                    <td class="text-end color-yellow text-bold {{ $before_total_5 < 0 ? 'error-message' : '' }}">
